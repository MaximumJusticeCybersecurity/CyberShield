// 20260602-1945 TrustMap Engine Layout Preview Fix
...
export function installTrustMapEngineLayoutStyles(){
  ...
  style.textContent = `
    ...
    .tm-engine-asset-frame-square-black:after{content:attr(data-trustmap-engine-frame);position:absolute;inset:auto 6px 6px 6px;z-index:0;color:rgba(223,249,255,.28);font-size:.62rem;text-transform:uppercase;letter-spacing:.04em;pointer-events:none}
