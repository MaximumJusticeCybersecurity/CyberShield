import './ui/v52-7-operational-layer.js';
...
async function init() {
  ...
  $('#downloadProof').onclick = () => { const blob = new Blob([proof()], { type: 'text/plain' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'cybershield-proof-pack-v52-7.txt'; a.click(); URL.revokeObjectURL(url); };
